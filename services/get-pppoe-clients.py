...
post_url = 'http://localhost:5001/api/pppoe/create'
...
if response.status_code == 200:
    ...
    check_database_for_identity = f'http://localhost:5001/api/pppoe/read/mikrotikName/{encoded_mikrotik_name}'
    ...
    if response_database_for_identity.status_code == 200 and response_database_for_identity.text.strip():
        try:
            ...
            if mikrotik_name == mikrotik_name_from_db:
                ...
                edit_url = f'http://localhost:5001/api/pppoe/update/{id_from_db}'
