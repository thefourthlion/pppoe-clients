...
post_url = 'https://apiip.portkeylabs.net/api/pppoe/create'
...
if response.status_code == 200:
    ...
    check_database_for_identity = f'https://apiip.portkeylabs.net/api/pppoe/read/mikrotikName/{encoded_mikrotik_name}'
    ...
    if response_database_for_identity.status_code == 200 and response_database_for_identity.text.strip():
        try:
            ...
            if mikrotik_name == mikrotik_name_from_db:
                ...
                edit_url = f'https://apiip.portkeylabs.net/api/pppoe/update/{id_from_db}'
